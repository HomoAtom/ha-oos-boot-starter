...
public enum ContentTypeEnum {
    ...
    ContentTypeEnum(String fileType, String explain, String contentType) {
    ...
    /**
     * 根据文件类型获取 ContentType枚举类
     *
     * @param fileType
     * @return ContentType枚举类
     */
    public static ContentTypeEnum findByFileType(String fileType) {
        if (StrUtil.isBlank(fileType)) {
            return null;
        }
        for (ContentTypeEnum typesEnum : ContentTypeEnum.values()) {
            if (fileType.equalsIgnoreCase(typesEnum.fileType)) {
                return typesEnum;
            }
        }
        return null;
    ...
    public static String getContentType(String fileType) {
        ContentTypeEnum contentTypeEnum = ContentTypeEnum.findByFileType(fileType);
        if (contentTypeEnum != null) {
            return contentTypeEnum.contentType;
        }
